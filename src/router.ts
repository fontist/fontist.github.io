...
export const routes: RouteRecordRaw[] = [
  ...
  { path: '/families', name: 'families-index', component: () => import('./pages/FamiliesPage.vue') },
  { path: '/families/:familySlug(.+)', name: 'font-family', component: () => import('./pages/FontFamilyPage.vue') },
  { path: '/families/:familySlug(.+)/unicode', name: 'font-family-unicode', component: () => import('./pages/FontFamilyUnicodePage.vue') },
  { path: '/fonts/:fontSlug(.+)', name: 'font-style', component: () => import('./pages/FontStylePage.vue') },
  { path: '/fonts/:fontSlug(.+)/unicode', name: 'font-style-unicode', component: () => import('./pages/FontStyleUnicodePage.vue') },
  { path: '/fonts/:fontSlug(.+)/unicode/block/:blockSlug', name: 'font-block-coverage', component: () => import('./pages/FontBlockCoveragePage.vue') },
  ...
  { path: '/guide', name: 'guide-index', component: () => import('./pages/GuidePage.vue') },
  { path: '/guide/:path(.*)*', name: 'guide', component: () => import('./pages/GuideTopicPage.vue') },
  { path: '/licenses', name: 'licenses-index', component: () => import('./pages/LicensesPage.vue') },
  { path: '/licenses/:path(.*)*', name: 'licenses', component: () => import('./pages/LicenseDetailPage.vue') },
